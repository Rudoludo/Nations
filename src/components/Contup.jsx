...
export default function CountUp({
  ...
  const factor = (to < 20 ? 1 : 3.5)

  // Calculate damping and stiffness based on duration
  const damping = 20 + 40 * (1 / duration) * (1/factor) ; // Adjust this formula for finer control
  const stiffness = 100 * (1 / duration) * factor;   // Adjust this formula for finer control
